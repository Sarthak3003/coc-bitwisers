...
function ObjectDetect() {
    ...
    return (
        <>
            ...
            {!loading ? <Button onClick={addProduct} sx={{ textTransform: 'none', height: '3rem', marginTop: '3%', width: '100%', border: '2px solid #E5659B', '&:hover': { border: '2px solid #E5659B !important', backgroundColor: 'white !important', color: '#E5659B !important' }, ...AddBtn }} > Add Product</Button> : <Box sx={{ display: 'flex', justifyContent: 'center' }}>
