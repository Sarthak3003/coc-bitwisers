  ...
  return (
    <>
      ...
      <Stack direction="row" alignItems="center" justifyContent="space-between" sx={{ my: 2 }}>
        ...
        <Link sx={{ color: "#E5659B" }} variant="subtitle2" underline="hover">
          Forgot password?
        </Link>
      </Stack>

      {!load ? <LoadingButton sx={{ backgroundColor: "#E5659B" }} onClick={handleClick} fullWidth size="large" type="submit" variant="contained">
        Login
